...
<body>
	<div class="layui-form-item" style="text-align: right;">
		<div class="layui-inline">
			...
			<button onclick="printdiv('div_print')">打印</button>
			<button onclick="javascript :history.go(-1);">返回</button>
		</div>
	</div>
	<fieldset>
		<legend style="font-weight: bold;">体检报告打印</legend>
		<div id="div_print">
			<p>
			<div style="text-align: center;">
				<table style="width: 100%;">
					<tr>
						<td><label style="font-weight: bold; font-size: 20px;">健
								康 体 检 中 心</label></td>
