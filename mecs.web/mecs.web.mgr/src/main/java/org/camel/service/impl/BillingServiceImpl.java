...
public class BillingServiceImpl implements BillingService {
	...
	public JSONObject getUserInfoByCardNum(String cardNum) {
		...
		System.out.println("cardList = " + cardIdList.size());
	...
	public JSONObject sureBilling(List<String> comboList, String mrPrice, String cardNum, Admin admin)
		...
		MecRecord mecRecord = new MecRecord(mrId, mrNum, cardId, comboName, mrPrice, admin.getAdminId(), null, null, null, "1", null, null, null, null);
