	...
	<body class="layui-layout-body">
		<div class="layui-layout layui-layout-admin">
			<div class="layui-body" style="left: 15px; top: 10px;right: 15px;">
				...
				<div class="table-body" style="height: 310px;overflow-y: scroll;">
					<table class="layui-table" lay-size="sm">
						<colgroup>
							<col width="200">
							<col />
				...
				<!-- <div class="layui-form-item">
					<div class="layui-inline" style="margin: 0px 0px 0px 180px;">
						<div class="layui-btn-container">
							<button type="button" class="layui-btn" id="close">返回</button>
						</div>
					</div>
				</div> -->
			</div>
